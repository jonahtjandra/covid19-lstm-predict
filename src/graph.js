...
import {LineChart, CartesianGrid, XAxis,YAxis,Tooltip,Line,Brush,AreaChart,Area} from 'recharts'
    ...
    return (
        <div className="line-chart-wrapper">
          <LineChart
            ...
            <XAxis dataKey="date" label="Date" label={{position:'bottom'}}/>
            <YAxis domain={['auto', 'auto']} label={{ value: "Stock Price", angle: -90, position: 'left' }} />
            <Tooltip
              wrapperStyle={{
                borderColor: 'white',
